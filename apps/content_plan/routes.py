...
@content_plan_bp.route('/results/<job_id>', methods=['GET'])
def results(job_id):
    try:
        job = Job.query.get_or_404(job_id)
...
def init_app(app):
    """Initialize the content plan app with the Flask app"""
